...
Yaml file for the signal: 
```yaml
  signal:
    name: FTDSignal
    ftd_min_gain: 0.02 
    rally_attempt_days: 4
```

Run 
`uv run python backfire/visualize_signal.py --signal my_signal.yaml --signal.name=FTDSignal --signal.ftd_min_gain=0.02 --signal.rally_attempt_days=4`
